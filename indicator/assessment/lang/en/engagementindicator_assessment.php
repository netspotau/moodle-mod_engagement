...
$string['dayslate_help'] = 'Number of days late that the assignment was submitted.  This takes into account any overrides in place which effect the user\'s due date..';
$string['localrisk'] = 'Local Risk';
$string['localrisk_help'] = 'The risk percentage of this assessment alone, out of 100.  The local risk is multiplied by the assessment weighting to form the Risk Contribution.';
$string['logic'] = 'Logic';
...
$string['override_help'] = 'Some assessment activities (ie: quiz) contain a feature for configuring alternate due dates for individual users or groups of users.  This field indicates that this user\'s due date was effected by an override.';
$string['riskcontribution'] = 'Risk Contribution';
$string['riskcontribution_help'] = 'The amount of risk this particular assessment contributes to the overall risk returned for the Assessment indicator.  This is formed by multiplying the Local Risk with the assessment Weighting.  The Risk Contributions of each assessment are summed together to form the overall risk for the indicator.';
$string['status'] = 'Status';
$string['status_help'] = 'Status indicates whether the user has submitted this assessment or not.';
$string['weighting'] = 'Weighting';
$string['weighting_help'] = 'This figure shows the max grade of this assessment as a percentage of total max grade for all assessments tracked by the Assessment Indicator.  The local_weighting will be multiplied by this to form the risk contribution.';
